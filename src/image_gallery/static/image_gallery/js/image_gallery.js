...
function initGallery(url, del_url, cadd_url, zip_url){
	gallery_upload_url = url;
	gallery_delete_url = del_url;
	category_add_url = cadd_url;
	zip_upload_url = zip_url;
	// using jQuery
	...
	CSRFN = 'csrfmiddlewaretoken';
	CSRFV = getCookie('csrftoken');
	
	
	//console.log(CSRFN, CSRFV);
